...
const routes = [
    ...
    {
        path: 'dashboard',
        loadChildren: () => Promise.all(/*! import() | pages-dashboard-dashboard-module */[__webpack_require__.e("default~home-home-module~pages-chat-chat-module~pages-dashboard-dashboard-module~pages-dashboard-hom~2713fb20"), __webpack_require__.e("default~pages-dashboard-dashboard-module~pages-dashboard-home-home-module~pages-dashboard-main-list-~c6908d57"), __webpack_require__.e("pages-dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./pages/dashboard/dashboard.module */ "./src/app/pages/dashboard/dashboard.module.ts")).then(m => m.DashboardPageModule)
    },
    {
        path: 'thumbnail',
...
let AuthenticationService = class AuthenticationService {
    constructor(storage, plt, afs, database, http) {
        ...
        this.baseUrl = "http://sherkarsunil2-001-site1.atempurl.com/api/";
