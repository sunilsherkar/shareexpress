...
const routes = [
    ...
    {
        path: 'Capture',
        loadChildren: () => Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~home-home-module~pages-chat-chat-module~pages-dashboard-dashboard-module~pages-dashboard-hom~2713fb20"), __webpack_require__.e("default~home-home-module~pages-dashboard-home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/pages/dashboard/home/home.module.ts")).then(m => m.HomePageModule)
    },
    {
        path: 'profile',
        loadChildren: () => __webpack_require__.e(/*! import() | profile-profile-module */ "profile-profile-module").then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/pages/dashboard/profile/profile.module.ts")).then(m => m.ProfilePageModule)
    },
    {
        path: 'main-list',
        loadChildren: () => __webpack_require__.e(/*! import() | main-list-main-list-module */ "common").then(__webpack_require__.bind(null, /*! ./main-list/main-list.module */ "./src/app/pages/dashboard/main-list/main-list.module.ts")).then(m => m.MainListPageModule)
    },
    {
        path: 'thumbnail',
        loadChildren: () => __webpack_require__.e(/*! import() | thumbnail-thumbnail-module */ "default~pages-dashboard-thumbnail-thumbnail-module~thumbnail-thumbnail-module").then(__webpack_require__.bind(null, /*! ./thumbnail/thumbnail.module */ "./src/app/pages/dashboard/thumbnail/thumbnail.module.ts")).then(m => m.ThumbnailPageModule)
    }
];
...
/* harmony import */ var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic-native/file-opener/ngx */ "./node_modules/@ionic-native/file-opener/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _service_authentication_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../service/authentication.service */ "./src/app/pages/service/authentication.service.ts");
/* harmony import */ var _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/social-sharing/ngx */ "./node_modules/@ionic-native/social-sharing/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _ionic_native_base64_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/base64/ngx */ "./node_modules/@ionic-native/base64/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _pages_chat_chat_page__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../pages/chat/chat.page */ "./src/app/pages/chat/chat.page.ts");
/* harmony import */ var _pages_dashboard_main_list_main_list_page__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../pages/dashboard/main-list/main-list.page */ "./src/app/pages/dashboard/main-list/main-list.page.ts");
/* harmony import */ var _pages_effect_effect_page__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../pages/effect/effect.page */ "./src/app/pages/effect/effect.page.ts");
...
let DashboardPage = class DashboardPage {
    constructor(plt, alertCtrl, fileOpener, router, route, toastCtrl, api, file, storage, fileChooser, database, socialSharing, downloader, filePathobject, base64, httpClient, http, modal) {
        this.plt = plt;
    ...
    download(UploadID, fileName, FilePath) {
    ...
    toBaseImg(location) {
        ...
        this.filePathobject.resolveNativePath(location).then((nativepath) => {
            this.base64.encodeFile(nativepath).then((base64File) => {
                ...
                }).catch((error) => { alert(error); this.Shareloader(false); });
            }).catch((error) => { alert(error); this.Shareloader(false); });
        }).catch((error) => { alert(error); this.Shareloader(false); });
    }
    ...
    like(UploadID, isShare, isLike, isDownload) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_15__["HttpHeaders"]({
