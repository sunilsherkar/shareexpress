...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  function srcAppPagesLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(router, api, afs, database, storage, httpClient, http, loadingController) {
      ...
      _createClass(LoginPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {//this.getmobile();
        }
      }, {
        ...
        value: function ionViewWillEnter() {
          ...
          this.storage.get(this.Token).then(function (res) {
            if (!res) {//this.route.navigateByUrl('login');
            } else {
        ...
        value: function LoginExist() {
          ...
          if (this.Password != "" && this.Password != undefined && this.Mobile != "" && this.Mobile != undefined) {
            var data = 'MobileNo=' + this.Mobile + '&Password=' + this.Password;
            var url = this.api.baseUrl + "Login/GetUserLogin?" + data;
            this.films = this.httpClient.get(url);
            this.films.subscribe(function (data) {
              _this2.loginData = data;

              if (data != null) {
                _this2.api.UserID = data["UserID"];

                _this2.storage.set('UserID', data["UserID"]);

                _this2.storage.set('fullName', data["Name"]).then(function () {
                  _this2.api.authenticationState.next(true);
                ...
                _this2.ErrorMessage = "Invalid Login";
        ...
        value: function CreateUser() {
          ...
          if (this.Name != "" && this.Password != "" && this.Mobile != "" && this.Mobile != undefined && this.Password != undefined && this.Name != undefined) {
            ...
            var url = this.api.baseUrl + "Login/PostCreateLogin";
            this.http.post(url, param, {}).then(function (data) {
              _this3.loginData = data;

              if (data != null) {
                _this3.api.UserID = data["UserID"];

                _this3.storage.set('UserID', data["UserID"]);

                _this3.storage.set('fullName', data["Name"]).then(function () {
                  _this3.api.authenticationState.next(true);
