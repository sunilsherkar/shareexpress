...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~home-home-module~pages-dashboard-home-home-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesDashboardHomeHomePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesDashboardHomeHomeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesDashboardHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesDashboardHomeHomePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesDashboardHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _service_image_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var _dashboard_main_list_main_list_page__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ../../dashboard/main-list/main-list.page */
    ...
    */
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(fileChooser, file, storage, plt, fileOpener, alertCtrl, route, toastCtrl, filePath, database, ImageService, api, socialSharing, base64, httpClient, http, router, loadingController, modal) {
      ...
      _createClass(HomePage, [{
        ...
        value: function GetMyPosts() {
          ...
          this.loadingpopup();
          var data = 'id=' + this.api.UserID + '&CategoryID=1&isSelf=1';
        ...
        value: function copyFileToLocalDir(fullPath) {
          ...
          var copyTo = this.file.dataDirectory + this.MEDIA_FOLDER_NAME;
          this.file.copyFile(copyFrom, name, copyTo, newName).then(function (success) {// this.loadFiles();
          }, function (error) {});
        }
      }, {
        key: "uploadFile",
        value: function uploadFile(f) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
            ...
            var path, ext, type, buffer, fileBlob, randomId, uploadTask;
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 5:
                    ...
                    alert(ext);
                    randomId = Math.random().toString(36).substring(2, 8) + '.' + ext;
                    ...
                    uploadTask.percentageChanges().subscribe(function (change) {
                      // alert(change);
                      _this2.uploadProgress = change;
                    });
                    uploadTask["catch"](function (res) {
        ...
        value: function uploadThumb() {
          ...
          var storageRef = firebase_app__WEBPACK_IMPORTED_MODULE_9__["storage"]().ref(); // Create a timestamp as filename

          var filename = Math.floor(Date.now() / 1000);
          this.thumbImagePath = filename + ".jpg";
          var imageRef = storageRef.child("Thumb/".concat(filename, ".jpg"));
        ...
        value: function saveImagetodb() {
          ...
          debugger;
          var exts = this.VideoFilepath.split('.').pop();
          var param = {
            "UploadID": 0,
            "Extension": exts,
          ...
          var url = this.api.baseUrl + "Media/PostSaveMedia";
        ...
        key: "geturlVideo",
        value: function geturlVideo() {
          var _this6 = this;

          this.saveFile = []; //const storageRef = firebase.storage().ref(); 

          var vurl = 'Status/' + this.VideoFilepath;
        ...
        value: function geturlImage() {
          ...
          var starsRef = firebase_app__WEBPACK_IMPORTED_MODULE_9__["storage"]().ref().child(vurl);
          starsRef.getDownloadURL().then(function (result) {
            _this7.saveFile.push({
              path: result
            });

            _this7.saveImagetodb();
          });
        }
      }, {
        key: "geturlThumb",
        value: function geturlThumb() {
          ...
          this.thumbFile = [];
          var vurl = 'Thumb/' + this.thumbImagePath;
          var starsRef = firebase_app__WEBPACK_IMPORTED_MODULE_9__["storage"]().ref().child(vurl);
          starsRef.getDownloadURL().then(function (result) {
            _this8.thumbFile.push({
              path: result
            });
        ...
        key: "uploadOnServer",
        value: function uploadOnServer(event) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
            var _this9 = this;

            var folder, exts1, fileRef, dataUrl;
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    folder = "Status/";
                    this.VideoFilepath = "".concat(new Date().getTime(), "_").concat(this.selectedfile.name); //File reference

                    exts1 = this.VideoFilepath.split('.').pop();

                    if (exts1 == "jpg" || exts1 == "jpeg" || exts1 == "png" || exts1 == "gif") {
                      this.uploadImage();
                    } else {
                      fileRef = this.storage.ref(folder + this.VideoFilepath);
                      dataUrl = URL.createObjectURL(event.item(0));
                      this.add(dataUrl);
                      this.storage.upload(folder + this.VideoFilepath, this.selectedfile).then(function (snapshot) {
                        var exts = snapshot.ref.name.split('.').pop();
        ...
        value: function getcurrentFiles(fieldname) {
          ...
          if (fieldname == "UploadID") {
            ...
            this.Curindex = this.MyFiles.findIndex(function (obj) {
              return obj.UploadID == _this11.UploadID;
            });
    ...
    HomePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/dashboard/home/home.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./home.page.scss */
      "./src/app/pages/dashboard/home/home.page.scss"))["default"]]
    })], HomePage);
    /***/
  }
}]);
//# sourceMappingURL=default~home-home-module~pages-dashboard-home-home-module-es5.js.map